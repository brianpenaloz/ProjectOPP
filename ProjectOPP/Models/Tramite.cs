    ...
    public class Tramite
    {
        ...
        public void CreatePDFOneDocument()
        {
            ...
            */
            ...
            document.ShowTextAligned(senhores, xMinimo, y - 120, 1, TextAlignment.LEFT, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(empresa, xMinimo, y - 130, 1, TextAlignment.LEFT, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(ruc, xMinimo, y - 140, 1, TextAlignment.LEFT, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(direccionEmpresa, xMinimo, y - 150, 1, TextAlignment.LEFT, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(presente, xMinimo, y - 160, 1, TextAlignment.LEFT, VerticalAlignment.TOP, 0);
            ...
            Paragraph primerParrafo = new Paragraph("Es grato dirigirnos a su Despacho, para expresarle nuestro saludo cordial, en nombre de la Facultad de Ingeniería Industrial y de Sistemas, de la Universidad Nacional Federico Villarreal, y a la vez, presentarles a:");
            primerParrafo.SetTextAlignment(TextAlignment.JUSTIFIED);
            primerParrafo.SetFontSize(12);

            Paragraph estudiante = new Paragraph("PEÑALOZA ORTEGA, BRIAN");
            estudiante.SetTextAlignment(TextAlignment.JUSTIFIED_ALL);
            estudiante.SetFontSize(12);

            Paragraph segundoParrafo = new Paragraph("Estudiante del 9no. Ciclo de Estudios, con Código de Matricula N.º 2014002507 de la Carrera Profesional de Ingeniería de Sistemas, y de conformidad con lo establecido en la Ley Nº 28518 “Ley de Modalidades Formativas Laborales”, solicitarle le permita realizar sus Prácticas Pre Profesionales en su prestigiosa empresa; para lo cual utilizará todos los conocimientos adquiridos en esta Facultad.");
            segundoParrafo.SetTextAlignment(TextAlignment.CENTER);
            segundoParrafo.SetFontSize(12);

            Paragraph tercerParrafo = new Paragraph("Vuestra aceptación permitirá que el (la) mencionado (a) estudiante, complete su desarrollo profesional aplicando sus conocimientos a la realidad empresarial, y cumpla con su Plan de Estudios de acuerdo a normas académicas vigentes, en esta Casa Superior de Estudios.");
            tercerParrafo.SetTextAlignment(TextAlignment.CENTER);
            tercerParrafo.SetFontSize(12);

            document.ShowTextAligned(representante, 300, y - 200, 1, TextAlignment.CENTER, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(cargo, 400, y - 220, 1, TextAlignment.CENTER, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(primerParrafo, xMinimo, y - 240, 1, TextAlignment.JUSTIFIED, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(estudiante, xMinimo, y - 260, 1, TextAlignment.JUSTIFIED_ALL, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(segundoParrafo, xMinimo, y - 280, 1, TextAlignment.CENTER, VerticalAlignment.TOP, 0);
            document.ShowTextAligned(tercerParrafo, xMinimo, y - 300, 1, TextAlignment.CENTER, VerticalAlignment.TOP, 0);
